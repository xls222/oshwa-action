...
var mergeConfig = __nccwpck_require__(7480);
var validator = __nccwpck_require__(685);
...
module.exports = __nccwpck_require__(5146)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __nccwpck_require__(2565);
...
try {
	...
	const supportsColor = __nccwpck_require__(7865);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(316)("follow-redirects");
    }
    catch (error) { /* */ }
